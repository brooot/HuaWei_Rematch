...
#define ui unsigned int      // 定义 ui 为无符号整型类型

// #define listSize 4294967296  // 定义数组的大小 = 4294967295 + 1 (unsigned int 的最大值 + 1)
#define listSize 300000  // 定义数组的大小 = 4294967295 + 1 (unsigned int 的最大值 + 1)
...
bool id_is_recorded[listSize];  //读数据的时候标记id是否被记录过,之后在拓扑排序的时候标记是否是合法id

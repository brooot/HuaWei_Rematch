...
int charSize[50000]; // 记录数字对应的char大小
char char_Int[50000][6]; //记录id对应的char数组

int inNeighborhoods1[50000];
int lastPoint1[50000];
int withLastOne1[50000];
int withLastSecond1[50000];

int inNeighborhoods2[50000];
int lastPoint2[50000];
int withLastOne2[50000];
int withLastSecond2[50000];

int inNeighborhoods3[50000];
int lastPoint3[50000];
int withLastOne3[50000];
int withLastSecond3[50000];

int inNeighborhoods4[50000];
int lastPoint4[50000];
int withLastOne4[50000];
int withLastSecond4[50000];
